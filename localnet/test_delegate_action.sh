...
ROLLOVER=0
run add_program 0 100000000000000 10000000000 1 1 1 $ROLLOVER $TOMORROW '{"delegate":{"minimum_actions":"0","maximum_actions":"1","minimum_delegation_amount":{"denom":"nhash","amount":"0"},"maximum_delegation_amount":{"denom":"nhash","amount":"1000000000000"},"minimum_active_stake_percentile":"0.750000000000000000","maximum_active_stake_percentile":"1.000000000000000000"}}'
print_program_status

# Start the reward program
wait_for_next_day
run delegate 0 0 1000000nhash
