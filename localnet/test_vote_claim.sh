...
ROLLOVER=0
run add_program 0 100000000000000 10000000000 1 1 1 $ROLLOVER $TOMORROW '{"vote":{"minimum_actions":"0","maximum_actions":"1","minimum_delegation_amount":{"denom":"nhash","amount":"1000"}}}'
